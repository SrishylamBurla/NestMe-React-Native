...
const AdminSupportChatScreen = ({ navigation, route }) => {
  ...
  const [replyTicket, { isLoading: sending }] =
    useReplyAdminSupportTicketMutation();
              ...
              <View style={styles.statusContainer}>
                {STATUS_OPTIONS.map(status => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.statusButton,
                      ticket?.status === status && styles.activeStatus,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        ...
                        ticket?.status === status && styles.activeStatusText,
                      ]}
                    >
                      {status}
                    </Text>
