...
export default function CheckoutScreen() {
  ...
  const { data: me, refetch: refetchUser } = useGetMeQuery();
  ...
  const { refetch: refetchSubscription } = useGetAgentSubscriptionQuery();

  const country = RNLocalize.getCountry();

  const defaultGateway = country === 'IN' ? 'razorpay' : 'stripe';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <PlanCard plan="Basic" price={price} />
