...
export default function ProfileScreen() {
  ...
  const propertiesCount = user?.propertiesPosted || 0;
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <Modal visible={showLogout} transparent animationType="fade">
              <View style={styles.modalOverlay}>
                <View style={styles.logoutModal}>
                  <Ionicons name="log-out-outline" size={56} color="#EF4444" />
            ...
            <View style={styles.footer}>
              <Text style={styles.footerLogo}>NestMe</Text>
...
function MenuItem({ icon, title, subtitle, badge, danger, onPress }) {
  return (
    <TouchableOpacity
      activeOpacity={0.85}
